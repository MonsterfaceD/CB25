...
public class LR1Set extends HashSet<LR1Item> {
     ...
     */
    public boolean hasConflicts(Alphabet lookahead) {
        int canShift = 0;
        int canReduce = 0;
        ...
        if (canReduce >= 2) {
            System.out.println("RED/RED conflict "+this.getSequenceAsString()+": " + this);
            return true; // reduce/reduce conflict
        }
        if (canReduce >= 1 && canShift >= 1) {
            System.out.println("SFT/RED conflict "+this.getSequenceAsString()+": " + this);
