...
def check_ex4(bin_path, name, quiet):
    ...
    shutil.copyfile(os.path.join(unittest_path_reference, "LR1SetGeneratorReference.java"), os.path.join(unittest_path, "LR1SetGeneratorReference.java"))
    shutil.copyfile(os.path.join(unittest_path_reference, "LR1ParserReference.java"), os.path.join(unittest_path, "LR1ParserReference.java"))
    ...
    for (tokens_file, grammar_file, input_file, lr0_valid, input_valid) in tests_ex4:
        ...
        if 'First sets correct.' in outputstr:
            correctFirst += 1
        if 'LR0 parsing correct.' in outputstr:
            correctLR0Parsing += 1
        if 'LR1 sets correct.' in outputstr:
            correctLR1Sets += 1
        if 'LR1 conflicts correct.' in outputstr:
            correctLR1Conflicts += 1
        if 'LR1 parsing correct.' in outputstr:
            correctLR1Parsing += 1
    ...
    print("{}/{} correct first sets".format(correctFirst, noTotal))
    print("{}/{} correct LR1 sets".format(correctLR1Sets, noTotal))
    print("{}/{} correct LR1 conflicts".format(correctLR1Conflicts, noTotal))
    print("{}/{} correct LR1 parsing".format(correctLR1Parsing, noTotal))
    return correctLR0Sets == noTotal and correctLR0Conflicts == noTotal and correctLR0Parsing == noTotal and correctFirst == noTotal and correctLR1Sets == noTotal and correctLR1Conflicts == noTotal and correctLR1Parsing == noTotal
