 ...
 * exprmult    -> exprmult TIMES subexpr | exprmult DIV subexpr | exprmult MOD subexpr | subexpr
...
public class WhileGrammar extends AbstractGrammar {
	...
	public WhileGrammar(Tokens tokens) throws Exception {
		...
		// exprmult -> subexpr TIMES expr | subexpr DIV expr | subexpr MOD expr | subexpr
